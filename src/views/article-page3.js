      ...
      >
        ...
        <div data-thq="thq-navbar-nav" className="article-page3-desktop-menu">
          <nav className="article-page3-links">
            <span>Home</span>
            <span className="article-page3-nav2">About Me</span>
            <span className="article-page3-nav3">Resume</span>
            <span className="article-page3-nav4">Articles</span>
            <span className="article-page3-nav5">Testimonials</span>
            <span className="article-page3-nav51">Contact Me</span>
          </nav>
          <div className="article-page3-buttons"></div>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="article-page3-mobile-menu">
          <div className="article-page3-nav">
            ...
            <div className="article-page3-buttons1">
        ...
        <footer className="article-page3-footer1">
          <div className="article-page3-container2">
            ...
            <nav className="article-page3-nav1 article-page3-nav1">
              <span className="article-page3-nav12">Home</span>
              <span className="article-page3-nav22">About Me</span>
              <span className="article-page3-nav32">Resume</span>
              <span className="article-page3-nav42">Articles</span>
              <span className="article-page3-nav53">Testimonials</span>
              <span className="article-page3-nav54">Contact Me</span>
            </nav>
          </div>
