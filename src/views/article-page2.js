...
const ArticlePage2 = (props) => {
  return (
    <div className="article-page2-container">
      <Helmet>
        <title>ArticlePage2 - John Doubleseed</title>
        <meta property="og:title" content="ArticlePage2 - John Doubleseed" />
      </Helmet>
      <header
        data-thq="thq-navbar"
      ...
      >
        ...
        <div data-thq="thq-navbar-nav" className="article-page2-desktop-menu">
          <nav className="article-page2-links">
            <span>Home</span>
            <span className="article-page2-nav2">About Me</span>
            <span className="article-page2-nav3">Resume</span>
            <span className="article-page2-nav4">Articles</span>
            <span className="article-page2-nav5">Testimonials</span>
            <span className="article-page2-nav51">Contact Me</span>
          </nav>
          <div className="article-page2-buttons"></div>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="article-page2-mobile-menu">
          <div className="article-page2-nav">
            ...
            <div className="article-page2-buttons1">
        ...
        <footer className="article-page2-footer1">
          <div className="article-page2-container2">
            ...
            <nav className="article-page2-nav1 article-page2-nav1">
              <span className="article-page2-nav12">Home</span>
              <span className="article-page2-nav22">About Me</span>
              <span className="article-page2-nav32">Resume</span>
              <span className="article-page2-nav42">Articles</span>
              <span className="article-page2-nav53">Testimonials</span>
              <span className="article-page2-nav54">Contact Me</span>
            </nav>
          </div>
