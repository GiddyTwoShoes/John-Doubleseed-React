      ...
      >
        ...
        <div data-thq="thq-navbar-nav" className="article-page1-desktop-menu">
          <nav className="article-page1-links">
            <span>Home</span>
            <span className="article-page1-nav2">About Me</span>
            <span className="article-page1-nav3">Resume</span>
            <span className="article-page1-nav4">Articles</span>
            <span className="article-page1-nav5">Testimonials</span>
            <span className="article-page1-nav51">Contact Me</span>
          </nav>
          <div className="article-page1-buttons"></div>
        </div>
        ...
        <div data-thq="thq-mobile-menu" className="article-page1-mobile-menu">
          <div className="article-page1-nav">
            ...
            <div className="article-page1-buttons1">
        ...
        <footer className="article-page1-footer1">
          <div className="article-page1-container2">
            ...
            <nav className="article-page1-nav1 article-page1-nav1">
              <span className="article-page1-nav12">Home</span>
              <span className="article-page1-nav22">About Me</span>
              <span className="article-page1-nav32">Resume</span>
              <span className="article-page1-nav42">Articles</span>
              <span className="article-page1-nav53">Testimonials</span>
              <span className="article-page1-nav54">Contact Me</span>
            </nav>
          </div>
